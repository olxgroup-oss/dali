...
| `max_file_size`                     | integer                               | Maximum allowed size for the file to be processed. If the file size exceeds this limit, the download will be aborted.                                                                                                                                                                                                                                    | N                          | -                                                                                       | if not provided, Dali will not check the file size                                                                                                |
