...
pub struct Configuration {
    ...
    pub reqwest_timeout_millis: Option<u64>,
    pub reqwest_connection_timeout_millis: Option<u64>,
    pub reqwest_pool_max_idle_per_host: Option<usize>,
    pub reqwest_pool_idle_timeout_millis: Option<u64>,
